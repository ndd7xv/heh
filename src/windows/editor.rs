...
use super::{adjust_offset, KeyHandler, Window, search::{SearchDirection, perform_search}};
...
impl KeyHandler for Editor {
    ...
    fn enter(&mut self, data: &mut AppData, display: &mut ScreenHandler, labels: &mut LabelHandler) {
